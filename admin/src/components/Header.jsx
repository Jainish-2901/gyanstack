...
export default function Header() {
  ...
  const activeClass = ({ isActive }) => (isActive ? 'nav-link active fw-bold text-primary border-bottom border-primary px-1 mx-2' : 'nav-link px-1 mx-2');
      ...
      <div className="container-fluid px-3">
        ...
        <div className="d-flex align-items-center justify-content-between w-100 w-lg-auto">
          ...
          <div className="flex-grow-1">
            <Link className="navbar-brand fw-bold fs-4 text-primary" to="/" onClick={closeNav}>
          ...
          <div className="d-none d-lg-flex align-items-center gap-2 ms-auto"> 
            ...
            {!user ? ( 
              ...
              <div className="nav-item dropdown position-relative ms-2">
                <button 
                  className="btn btn-light text-primary fw-bold px-3 py-2 rounded-pill shadow-sm d-flex align-items-center border border-primary border-opacity-25"
