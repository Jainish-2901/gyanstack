...
export default function EditProfile() {
    ...
    return (
        <div className="container-fluid fade-in px-0 overflow-x-hidden">
            <h4 className="fw-bold mb-4 text-primary">Account Settings</h4>

            {success && <div className="alert alert-info alert-dismissible fade show border-0" role="alert">
                ...
                <div className="col-lg-6">
                    <div className="card h-100 border-0 rounded-4 overflow-hidden">
                        <div className="card-header bg-primary py-3">
                            <h5 className="card-title mb-0 fw-bold text-white"><i className="bi bi-person-gear me-2"></i>Update Details</h5>
                        </div>
                                ...
                                <div className="text-center mb-4">
                                    <div className="position-relative d-inline-block">
                                        ...
                                        <label htmlFor="image-upload"
                                            className="position-absolute bottom-0 end-0 btn btn-primary rounded-circle d-flex align-items-center justify-content-center border border-white border-2"
                                        ...
                                        {(previewUrl || user.profileImage) && !removeImageRequested && (
                                            <button
                                                type="button"
                                                className="position-absolute bottom-0 start-0 btn btn-danger rounded-circle d-flex align-items-center justify-content-center border border-white border-2"
                        ...
                        <div className="card h-100 border-0 rounded-4">
                            ...
                            <div className="card-body p-4">
                                <form onSubmit={handlePasswordSubmit}>
                                    ...
                                    <button type="submit" className="btn btn-warning w-100 fw-bold rounded-pill" disabled={loadingPassword}>
